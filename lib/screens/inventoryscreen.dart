...
class _InventoryScreenState extends State<InventoryScreen> {
  ...
  // ----------------------------------------------------------
  // A PARTIR DAQUI, TODOS OS OUTROS MÉTODOS ESTÃO DENTRO DA CLASSE
  // ----------------------------------------------------------
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Expanded(child: _buildBaseDropdown()),
            const SizedBox(width: 16),
  ...
  Widget _buildFooter() {
    ...
    int itensCriticos = _items.where((item) {
      bool baixo = item.qtdAlto <= item.qtdBaixo && item.qtdAlto > 0;
      bool esgotado = item.qtdAlto == 0;
      return baixo || esgotado;
    }).length;
          ...
          children: [
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const DetalheItemScreen()),
                );
              },
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => const CadastroMaterialScreen()),
                );
              },
